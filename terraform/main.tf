...
module "web_app" {
  ...
  app_settings             = merge(var.app_settings, {
    ...
    DATABASE_URL = "postgresql+asyncpg://${var.postgresql_admin_login}:${var.postgresql_admin_password != null ? var.postgresql_admin_password : random_password.postgresql_admin_password[0].result}@${module.database.private_dns_name}:5432/${var.postgresql_databases[0]}"
  })
